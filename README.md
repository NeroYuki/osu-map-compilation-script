...
- After that run the main.js script (whether `node main.js` or `npm run start`), type the number of map you want to merge, the length of each map's audio file in miliseconds , some metadata stuff and you are done, the result map is ready in the output folder
